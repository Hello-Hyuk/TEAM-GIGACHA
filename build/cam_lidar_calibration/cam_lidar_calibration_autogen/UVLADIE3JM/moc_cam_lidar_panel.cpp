...
#include "../../../../src/cam_lidar_calibration/src/cam_lidar_panel.h"
...
void cam_lidar_calibration::CamLidarPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CamLidarPanel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cam_lidar_calibration::CamLidarPanel::staticMetaObject = { {
    &rviz::Panel::staticMetaObject,
    qt_meta_stringdata_cam_lidar_calibration__CamLidarPanel.data,
    qt_meta_data_cam_lidar_calibration__CamLidarPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
