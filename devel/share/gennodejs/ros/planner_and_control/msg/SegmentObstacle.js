...
class SegmentObstacle {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('mid_point')) {
        this.mid_point = initObj.mid_point
      }
      else {
        this.mid_point = new geometry_msgs.msg.Point();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [mid_point]
    bufferOffset = geometry_msgs.msg.Point.serialize(obj.mid_point, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [mid_point]
    data.mid_point = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'bdb4bb46c5b808de9ab8a895007f4603';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.mid_point !== undefined) {
      resolved.mid_point = geometry_msgs.msg.Point.Resolve(msg.mid_point)
    }
    else {
      resolved.mid_point = new geometry_msgs.msg.Point()
    }
