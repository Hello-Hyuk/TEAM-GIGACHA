...
(cl:defmethod cl:initialize-instance :after ((m <Displacement>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Displacement)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name local_pkg-msg:<Displacement> is deprecated: use local_pkg-msg:Displacement instead.")))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <Displacement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader local_pkg-msg:left-val is deprecated.  Use local_pkg-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <Displacement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader local_pkg-msg:right-val is deprecated.  Use local_pkg-msg:right instead.")
  (right m))
