...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Local>)))
  ...
  "9a0166f196f8bebdacb83862e00fafb9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Local)))
  "Returns md5sum for a message object of type 'Local"
  "9a0166f196f8bebdacb83862e00fafb9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Local>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 heading~%float64 roll~%float64 pitch~%float64 dr_x~%float64 dr_y~%geometry_msgs/Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Local)))
  "Returns full string definition for message of type 'Local"
  (cl:format cl:nil "float64 x~%float64 y~%float64 heading~%float64 roll~%float64 pitch~%float64 dr_x~%float64 dr_y~%geometry_msgs/Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
