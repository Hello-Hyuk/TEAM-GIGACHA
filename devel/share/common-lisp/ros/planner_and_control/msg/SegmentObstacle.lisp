...
(cl:ensure-generic-function 'mid_point-val :lambda-list '(m))
(cl:defmethod mid_point-val ((m <SegmentObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_and_control-msg:mid_point-val is deprecated.  Use planner_and_control-msg:mid_point instead.")
  (mid_point m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SegmentObstacle>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'mid_point) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SegmentObstacle>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'mid_point) istream)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SegmentObstacle>)))
  ...
  "bdb4bb46c5b808de9ab8a895007f4603")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SegmentObstacle)))
  "Returns md5sum for a message object of type 'SegmentObstacle"
  "bdb4bb46c5b808de9ab8a895007f4603")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SegmentObstacle>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point first_point~%geometry_msgs/Point mid_point~%geometry_msgs/Point last_point~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SegmentObstacle)))
  "Returns full string definition for message of type 'SegmentObstacle"
  (cl:format cl:nil "geometry_msgs/Point first_point~%geometry_msgs/Point mid_point~%geometry_msgs/Point last_point~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SegmentObstacle>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'mid_point))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SegmentObstacle>))
  ...
  (cl:list 'SegmentObstacle
    ...
    (cl:cons ':mid_point (mid_point msg))
