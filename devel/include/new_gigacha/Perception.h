// Generated by gencpp from file new_gigacha/Perception.msg
// DO NOT EDIT!


#ifndef NEW_GIGACHA_MESSAGE_PERCEPTION_H
#define NEW_GIGACHA_MESSAGE_PERCEPTION_H
...
struct Perception_
{
  ...
  typedef boost::shared_ptr< ::new_gigacha::Perception_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::new_gigacha::Perception_<ContainerAllocator> const> ConstPtr;

}; // struct Perception_

typedef ::new_gigacha::Perception_<std::allocator<void> > Perception;

typedef boost::shared_ptr< ::new_gigacha::Perception > PerceptionPtr;
typedef boost::shared_ptr< ::new_gigacha::Perception const> PerceptionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::new_gigacha::Perception_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::new_gigacha::Perception_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::new_gigacha::Perception_<ContainerAllocator1> & lhs, const ::new_gigacha::Perception_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::new_gigacha::Perception_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::new_gigacha::Perception_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::new_gigacha::Perception_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::new_gigacha::Perception_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::new_gigacha::Perception_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::new_gigacha::Perception_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::new_gigacha::Perception_<ContainerAllocator> >
{
  ...
  static const char* value(const ::new_gigacha::Perception_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdbbed136df240d7fULL;
  static const uint64_t static_value2 = 0x479ccfd9293ea715ULL;
};

template<class ContainerAllocator>
struct DataType< ::new_gigacha::Perception_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::new_gigacha::Perception_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::new_gigacha::Perception_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::new_gigacha::Perception_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::new_gigacha::Perception_<ContainerAllocator>& v)
  {
    s << indent << "A_target: ";
...
#endif // NEW_GIGACHA_MESSAGE_PERCEPTION_H
