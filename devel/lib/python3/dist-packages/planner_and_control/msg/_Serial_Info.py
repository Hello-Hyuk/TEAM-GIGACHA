...
class Serial_Info(genpy.Message):
  _md5sum = "e0cf40a584f88ddbf7574c1bcf89548d"
...
float32 steer
int32 brake"""
  __slots__ = ['auto_manual','emergency_stop','gear','speed','steer','brake']
  _slot_types = ['int16','int16','int16','float32','float32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       auto_manual,emergency_stop,gear,speed,steer,brake
