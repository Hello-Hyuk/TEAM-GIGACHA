...
#read obs
python3 serial_io.py & python3 mission_planner.py & python3 behavior_planner.py & python3 motion_planner.py & python3 controller.py & python3 sensor_hub.pypython3 serial_io.py & python3 mission_planner.py & python3 behavior_planner.py & python3 motion_planner.py & python3 controller.py & python3 sensor_hub.py
#if [ $obs == "y" ];then
