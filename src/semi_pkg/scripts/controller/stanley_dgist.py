...
def stanley_control(state, cx, cy, cyaw, last_target_idx):
    ...
    # delta = k_e * (theta_e)
    # delta = theta_d
    delta = k_total*(k_e * theta_e + k_d * theta_d)
...
def execute(node_):
    ...
    # imuyawSub = node_.create_subscription(Float64, "/opencr/imu_yaw", gpsyawCallback, 0)
...
Blog
About
Control-Planning/0910_stanley_erp.py at master · DGIST-ARTIV/Control-Planning · GitHub