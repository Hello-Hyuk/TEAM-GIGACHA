...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        help='kcity/map1, songdo/map2, yonghyeon/Yonghyeon, kcity_simul/left_lane, kcity_simul/right_lane, kcity_simul/final, inha_parking/gpp, kcity_simul/kcitySTR, kcity_simul/parking_parallel_2_STR, Siheung/parking'
    )
