...
def parking(temp_points): 
    ...
    parking_space_3 = [parking_point_siheung_parallel[0], parking_point_siheung_parallel[1], parking_point_siheung_parallel[2], parking_point_siheung_parallel[3]] 
    ...
    parking_space_1 = [parking_point_siheung_parallel[8], parking_point_siheung_parallel[9], parking_point_siheung_parallel[10], parking_point_siheung_parallel[11]] 
